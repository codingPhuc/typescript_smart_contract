...
class Product {
  constructor(product_id, name, total_supply, price, decs, owner) {
...
class Shop {
  constructor(owner, name, desc, total_product) {
    this.owner = owner;
    this.name = name;
    this.desc = desc;
...
let Contrat = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = view(), _dec6 = call({}), _dec7 = view(), _dec8 = view(), _dec9 = call({}), _dec10 = view(), _dec(_class = (_class2 = class Contrat {
  platform_name = "";
  products_per_shop = new UnorderedMap('map-uid-1');
  product_per_id = new LookupMap('product by id');
  products = new Vector('products');
  shops = new UnorderedMap('shops');
  allshops = new Vector('all shop');
  total = 0;
  total_product = 0;
  init() {
    this.platform_name = currentAccountId();
  }
  new_shop({
    name,
    desc,
    ...
    let owner = currentAccountId();
    assert(!this.shops.get(owner), "shop already exits");
    let shop = new Shop(owner, name, desc, total_product);
  ...
  new_product({
    ...
    let products_set = this.products_per_shop.get(owner) ? this.products_per_shop.get(owner) : new Vector('map-uid-1');
  ...
  update_product({
    ...
    let product = this.get_product_by_id({
      product_id
    });
    product.price = price;
    this.product_per_id.set(product_id, product);
  ...
  get_products_by_owner(owner) {
    return this.products_per_shop.get(owner) ? this.products_per_shop.get(owner) : new Vector('map-uid-1');
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "new_shop", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "new_shop"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_shop_by_id", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_shop_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_shops", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_shops"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "new_product", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "new_product"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_products", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_products"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_product_by_id", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "get_product_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_product", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "update_product"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_products_by_owner", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "get_products_by_owner"), _class2.prototype)), _class2)) || _class); //near deploy --accountId dev-1690020417337-36849238982762 --wasmFile contract/build/hello-near.wasm
...
function get_products_by_owner() {
  const _state = Contrat._getState();
  if (!_state && Contrat._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Contrat._create();
  if (_state) {
    Contrat._reconstruct(_contract, _state);
  }
  const _args = Contrat._getArgs();
  const _result = _contract.get_products_by_owner(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function update_product() {
  ...
  Contrat._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function get_product_by_id() {
  ...
  const _args = Contrat._getArgs();
  const _result = _contract.get_product_by_id(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
...
function new_product() {
  ...
  const _args = Contrat._getArgs();
  const _result = _contract.new_product(_args);
  Contrat._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function get_all_shops() {
  ...
  const _args = Contrat._getArgs();
  const _result = _contract.get_all_shops(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function get_shop_by_id() {
  ...
  const _args = Contrat._getArgs();
  const _result = _contract.get_shop_by_id(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function new_shop() {
  const _state = Contrat._getState();
  ...
  const _args = Contrat._getArgs();
  const _result = _contract.new_shop(_args);
  Contrat._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contrat._serialize(_result, true));
}
function init() {
...
export { Product, Shop, get_all_products, get_all_shops, get_product_by_id, get_products_by_owner, get_shop_by_id, init, new_product, new_shop, update_product };
